...
model = joblib.load('network_predict.pkl')  # Ensure you have the trained model file
scaler = joblib.load('scaler.pkl')        # Ensure you have the scaler file

@app.route('/')

def home():
      return "Network Traffic Prediction API"
...
def predict():
      if request.method == 'POST':
           try:
               ...
               result = {'Prediction of Network Traffic Allowed in (GB)': round(prediction[0], 2)}
